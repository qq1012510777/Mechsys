...
#include <mechsys/dfn_c/Random_function.h>
#include <mechsys/dfn_c/Math.h>
...
namespace DFN
{
	...
	public:
		...
		// Constructor
		Fracture(String string_ori, String string_frac_size, size_t Tag, Random_function &c,
				 const Array<Vec2_t> array1, const Vec4_t array2 /*, const Vec7_t array3*/, double Last_frac_size);																		 ///< Fracture constructor as an array of vertices; uniform
		Fracture(String string_ori, String string_frac_size, size_t T, Random_function &c, const Array<Vec2_t> array1, const Vec4_t array2, const Vec7_t array3, double Last_frac_size); ///< Fisher

		Fracture(size_t _Tag, int _Clus, Array<Vec3_t> _Verts); ///< used to represent model surface
	};

	inline Fracture::Fracture(String string_ori, String string_frac_size, size_t T, Random_function &c, const Array<Vec2_t> array1, const Vec4_t array2, double Last_frac_size /*, const Vec7_t array3*/)
	{
	...
	inline Fracture::Fracture(String string_ori, String string_frac_size, size_t T, Random_function &c, const Array<Vec2_t> array1, const Vec4_t array2, const Vec7_t array3, double Last_frac_size)
	{
		If_intersect_surfaces = 0, 0, 0, 0, 0, 0;
		Tag = T;
		Clus = -1;
