...
//		if (dom.Particles[a]->ID==1) dom.Particles[a]->Density  = rhoF*((1+9.81*(4.5-dom.Particles[a]->x(1))/(CsF*CsF)));
	...
	rhoS	= 2038.7;  //Solid density
	Phi		= 25.0;    //Friction Angle
	Psi		= 0.0;     //Dilatancy
	k		= 10.0e-8;   //permeability
	c		= 5.0e3;   //cohesion
	E		= 25.0e6;  //Young modulus
	...
	dom.Solve(/*tf*/50000.0,/*dt*/T,/*dtOut*/0.2,"test03",2000);
	return 0;
}
MECHSYS_CATCH
